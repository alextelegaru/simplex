...
<form class="form-horizontal">
    ...
    <input type="number" name="mesa" id="mesa"  value={{$pedido->nMesa}} placeholder="0">
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls form-inline">
                        ...
                        <input type="text" name="nombre" value={{$pedido->nombre}} id="nombre" placeholder="Obligatorio">
...
echo '<option value="'.'Bebida: '.$x[3].'">'.'Bebida: '.$x[3].'</option>';
 ...
 $limite=count($x);
for($i=0;$i<$limite;$i++){
    $posicion = array_search($x[$i], $productosNombre);

    echo '<option value="'.'Producto: '.$x[$i].' '.$productosPrecio[$posicion].' €'.'">'.'Producto: '.$x[$i].' '.$productosPrecio[$posicion].' €'   .'</option>';
